...
{
    public partial class Ksenones : MenuBar
    {
        public Ksenones()
        {
            InitializeComponent();
        ...
        private void Ksenones_Load(object sender, EventArgs e)
        {
            ...
            sql_queries.ExecuteKsenonesssquery(query, richTextBox1, pictureBox2, pictureBox3, pictureBox4);
        }
