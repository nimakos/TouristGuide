...
{
    public partial class Plirofories : MenuBar
    {
        public Plirofories()
        {
            InitializeComponent();
        ...
        private void Plirofories_Load(object sender, EventArgs e)
        {
            ...
            sql_queries.ExecuteGenikasquery(query, richTextBox1, pictureBox2, pictureBox3, pictureBox4);
        }
