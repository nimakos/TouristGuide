...
{
    public partial class Arhitekt : MenuBar
    {
        public Arhitekt()
        {
            InitializeComponent();
        ...
        private void Arhitekt_Load(object sender, EventArgs e)
        {
            ...
            sql_queries.ExecuteArhitectquery(query, richTextBox1, pictureBox2, pictureBox3);
