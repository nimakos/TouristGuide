...
{
    public partial class Domatia : MenuBar
    {
        public Domatia()
        {
            InitializeComponent();
        ...
        private void Domatia_Load(object sender, EventArgs e)
        {
            ...
            sql_queries.ExecuteDwmatiasquery(query, richTextBox1, pictureBox2, pictureBox3, pictureBox4);
        }
